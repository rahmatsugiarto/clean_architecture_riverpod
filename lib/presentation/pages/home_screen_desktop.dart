...
class HomeScreenDesktop extends StatefulHookConsumerWidget {
...
class _HomeScreenState extends ConsumerState<HomeScreenDesktop> {
      ...
      body: Builder(builder: (context) {
        ...
        if (status.isLoading) {
          ...
          return CustomRefreshIndicator(
            ...
            noData: true,
            child: ErrorView(
              message: homeState.homeState.message,
            ),
          );
        }
      }),
